...
struct TaskBalancedCanvasTests {
    ...
    func test_AC4_truthfulPresentationBoundaries() throws {
        ...
        #expect(resume.contains("recoveryCoordinator.continueTask(progress)"))
        #expect(resume.contains("recoveryCoordinator.restartTask(progress)"))
        #expect(resume.contains("case recovering(TaskProgress)"))
