...
//          AC-3 (SigLIP2-B/32 视觉向量；原 MobileCLIP-B LT 已按 ADR-004 模型迁移移除), AC-4 (PHAsset 引用),
...
/// AC-3: `embedding` 为 SigLIP2-B/32 生成的视觉向量（ADR-004 迁移后，768d）。
...
public struct MemoryEntry: Sendable, Codable, Equatable {
    ...
    /// 视觉向量（SigLIP2-B/32 输出，768d），AC-3：与文本向量空间对齐
