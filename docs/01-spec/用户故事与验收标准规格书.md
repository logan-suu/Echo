...
**最近规格审查**：2026-09-01（4.0b Focus 表现边界、Notes 公开 API 与生产真实性）
...
- **用户故事**：当我换新 iPhone 时，我希望 Echo 的记忆数据、设置能通过本地设备间直接传输（如 AirDrop 或加密备份恢复）完整迁移，无需重新索引；如果目标设备已有数据，应提示我选择覆盖或合并，并在冲突时提供批量处理选项。
