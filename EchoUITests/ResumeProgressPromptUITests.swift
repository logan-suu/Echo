...
final class ResumeProgressPromptUITests: XCTestCase {
    ...
    func test_pendingJourneyContinue() throws {
        ...
        app.launchArguments = ["-ui-fixture", "resume-progress-pending"]
        app.launch()
    ...
    func test_errorFixtureShowsRetry() throws {
        let app = XCUIApplication()
        app.launchArguments = ["-ui-fixture", "resume-progress-error"]
        app.launch()
    ...
    func test_noneFixtureNoPrompt() throws {
        let app = XCUIApplication()
        app.launchArguments = ["-ui-fixture", "resume-progress-none"]
        app.launch()
