...
final class TranslationUITests: XCTestCase {
    ...
    func test_highConfidenceToggleShowsTranslation() throws {
        ...
        app.launchArguments = ["-ui-language", "en-US", "-ui-skip-consent", "-ui-fixture", "translation-zh-en-high"]
        app.launch()
    ...
    func test_lowConfidenceRetainsOriginal() throws {
        let app = XCUIApplication()
        app.launchArguments = ["-ui-language", "en-US", "-ui-skip-consent", "-ui-fixture", "translation-zh-en-low"]
        app.launch()
    ...
    func test_errorFixtureShowsRetry() throws {
        let app = XCUIApplication()
        app.launchArguments = ["-ui-language", "en-US", "-ui-skip-consent", "-ui-fixture", "translation-error"]
        app.launch()
