...
final class MemoryDetailMediaUITests: XCTestCase {
    ...
    func test_photoMediaPreview() throws {
        ...
        app.launchArguments = ["-ui-fixture", "memory-detail-photo-loaded"]
        app.launch()
    ...
    func test_videoMediaPreview() throws {
        let app = XCUIApplication()
        app.launchArguments = ["-ui-fixture", "memory-detail-video-loaded"]
        app.launch()
    ...
    func test_voiceMediaPreview() throws {
        let app = XCUIApplication()
        app.launchArguments = ["-ui-fixture", "memory-detail-voice-loaded"]
        app.launch()
